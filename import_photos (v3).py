...
def download_images_from_excel(file_path):
    ...
    for idx, row in df.iterrows():
        ...
        # Преобразуем артикул к строке и убираем ".0", пробелы
...
if __name__ == "__main__":
    excel_files = [
        r"C:\Users\3prokent\Documents\Python\аккумулятор\data(аккумулятор).xlsx",
        r"C:\Users\3prokent\Documents\Python\инструменты\data(инструменты).xlsx",
        r"C:\Users\3prokent\Documents\Python\набор\data(набор).xlsx",
        r"C:\Users\3prokent\Documents\Python\освещение\data(освещение).xlsx",
        r"C:\Users\3prokent\Documents\Python\пила\data(пила).xlsx",
        r"C:\Users\3prokent\Documents\Python\электродрели\data(электродрели).xlsx",
    ]
